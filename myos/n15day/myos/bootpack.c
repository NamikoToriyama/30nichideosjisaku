...
// マルチタスク用に使うレジスタ
struct TSS32 { // task status segment
...
void HariMain(void)
{
	...
	struct TSS32 tss_a, tss_b; // タスクを２つ作成
	...
	tss_b.fs = 1 * 8;
	tss_b.gs = 1 * 8;
	*((int *) (task_b_esp + 4)) = (int) sht_back; // taskBよう
	mt_init();
